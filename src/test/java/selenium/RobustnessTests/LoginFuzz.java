...
public class LoginFuzz {
    ...
    private final ArrayList<String> email = new ArrayList<String>(
            Arrays.asList("gmail.com", "hotmail.com", "yahoo.com"));
    ...
    /**
     * Function to generate random password. The generated password must have the
     * following requirements: 1. Contains upper and lower case 2. Contains numbers
     * and symbols 3. Has at least 8 characters
     */
